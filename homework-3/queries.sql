...
select customers.company_name, employees.last_name, employees.first_name from customers
...
where products.discontinued!=1 and units_in_stock<25 and categories.category_name in ('Dairy Products', 'Condiments')
